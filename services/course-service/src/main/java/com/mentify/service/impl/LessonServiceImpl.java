...
public class LessonServiceImpl implements LessonService {
    ...
    @Override
    @Transactional
    public ApiResponse<LessonResponse> createLesson(UUID courseId, UUID moduleId, LessonRequest request) {
    ...
    @Override
    @Transactional
    public ApiResponse<LessonResponse> updateLesson(UUID courseId, UUID moduleId, UUID lessonId, LessonRequest request) {
        Module module = moduleRepository.findByIdAndCourse_Id(moduleId, courseId)
                .orElseThrow(() -> new ResourceNotFoundException("Module", "id", moduleId));
