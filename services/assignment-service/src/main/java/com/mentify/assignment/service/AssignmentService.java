...
public interface AssignmentService {
    ...
    ApiResponse<AssignmentResponse> getTeacherAssignment(UUID assignmentId);
    ...
    ApiResponse<Object> deleteAssignment(UUID assignmentId);

    ApiResponse<List<StudentAssignmentResponse>> getPublishedAssignmentsByCourse(UUID courseId, String authorizationHeader);

    ApiResponse<StudentAssignmentResponse> getStudentAssignment(UUID assignmentId, String authorizationHeader);
}
